...
def teacher_screen_login():
    ...
    st.space()
    st.space()
    teacher_username=st.text_input("Enter username",placeholder='@chesta')
    ...
    with btnc1:
        if st.button('Login',icon=':material/passkey:',shortcut='control+backspace',width='stretch'):
...
def teacher_screen_register():
    ...
    st.space()
    teacher_username=st.text_input("Enter username",placeholder='@chesta')
    teacher_name=st.text_input("Enter name",placeholder='Chesta Chauhan')
    teacher_pass=st.text_input("Enter password",placeholder="Enter your password",type='password')
